...
type Attachment = { type: 'ticket' | 'task'; id: string; title: string };
...
function AttachPicker({ onPick, onClose }: { onPick: (a: Attachment) => void; onClose: () => void }) {
