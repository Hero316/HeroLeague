      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed left-3 right-3 top-[calc(env(safe-area-inset-top)+0.75rem)] w-auto sm:absolute sm:left-auto sm:right-0 sm:top-full sm:mt-2 sm:w-80 bg-[#0a1110] border border-white/10 rounded-2xl shadow-2xl shadow-black/50 z-[70] overflow-hidden"
          >
